...
package com.androidtv_test.view.main;
...
public class MainFragment extends BrowseFragment {
    ...
    private static final int NUM_ROWS = 6;//分類行數
    private static final int NUM_COLS = 15;//分類中的欄位數
    ...
    private void loadRows() {
        ...
        CardPresenter cardPresenter = new CardPresenter();//用來顯示每一個媒體項目
    ...
    private void prepareBackgroundManager() {
        ...
        mBackgroundManager.attach(getActivity().getWindow());//將背景與要顯示的畫面綁定

        mDefaultBackgroundDrawable = getResources().getDrawable(R.drawable.default_background);//設定預設的背景圖片

        mDisplayMetrics = new DisplayMetrics();//建立螢幕尺寸資訊類別
